...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon: Icon, title, description, details }) => {
  return (
    <div 
      className="service-card floating group h-full"
    >
      <div className="relative z-10 h-full flex flex-col">
        <div 
          className="mb-6 p-4 inline-block rounded-xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-3"
          style={{
        ...
        <h3 className="text-xl font-bold mb-4 holographic">{title}</h3>
      ...
      <div 
        className="absolute -right-8 -bottom-8 w-32 h-32 rounded-full opacity-20 transition-all duration-500 group-hover:scale-125 group-hover:opacity-30"
        style={{
